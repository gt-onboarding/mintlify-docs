...
<div id="enabling-support-integrations">
  ## Abilitazione delle integrazioni di supporto
</div>

Integra i widget di assistenza clienti nella documentazione. Aggiungi il campo `integrations` al file `docs.json` con il relativo ID dell’app.
