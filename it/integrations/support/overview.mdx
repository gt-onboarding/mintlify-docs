...
<div id="enabling-support-integrations">
  ## Abilitare le integrazioni di supporto
</div>

Integra i widget di supporto clienti nella tua documentazione. Aggiungi il campo `integrations` al file `docs.json` con il relativo ID dell’app.
