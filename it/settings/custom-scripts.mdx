...
Usa il CSS per formattare gli elementi HTML oppure aggiungi CSS e JavaScript personalizzati per personalizzare completamente l'aspetto e l'esperienza della tua documentazione.

<div id="styling-with-tailwind-css">
  ## Styling con Tailwind CSS
</div>

Usa Tailwind CSS v3 per stilizzare gli elementi HTML. Puoi controllare layout, spaziature, colori e altre proprietà visive. Alcune classi comuni sono:
...
Aggiungi i file CSS al tuo repository e i relativi nomi di classe definiti saranno applicati e disponibili in tutti i tuoi file `MDX`.

<div id="adding-stylecss">
  ### Aggiunta di `style.css`
</div>

Ad esempio, puoi aggiungere il seguente file `style.css` per personalizzare lo stile della navbar e del footer.
...
<div id="using-identifiers-and-selectors">
  ### Utilizzo di identificatori e selettori
</div>

Mintlify mette a disposizione un set di identificatori e selettori comuni per aiutarti a contrassegnare gli elementi importanti dell’interfaccia utente.
...
<Warning>
  I riferimenti e lo stile degli elementi comuni possono cambiare con l’evoluzione della piattaforma. Utilizza lo stile personalizzato con cautela.
</Warning>
...
Il JavaScript personalizzato consente di aggiungere codice eseguibile a livello globale. È l’equivalente di inserire un tag `<script>` con codice JavaScript in ogni pagina.
