---
title: "Introduzione"
description: "Scopri la nuova generazione di documentazione: nativa per l’IA, bellissima subito pronta e progettata per gli sviluppatori."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Scopri la nuova generazione di documentazione. Nativa per l’AI, bella fin da subito e progettata per gli sviluppatori.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Avvio rapido" description="Distribuisci il tuo primo sito di documentazione in pochi minuti con la nostra guida passo passo" href="/it/quickstart" />

      <HeroCard filename="cli" title="Installazione della CLI" description="Installa la CLI per visualizzare in anteprima e sviluppare la tua documentazione in locale" href="/it/installation" />
