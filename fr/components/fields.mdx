...
<ParamField body="query, path, body, or header" type="string">
  Indique si le paramètre est de type requête, chemin, corps ou en-tête, suivi du
  nom du paramètre.
</ParamField>
...
<ParamField body="placeholder" type="string">
  Texte d’exemple (placeholder) pour le champ dans le Terrain de jeu API.
</ParamField>

<ParamField body="children" type="string">
  Description du paramètre (prise en charge de Markdown).
</ParamField>
