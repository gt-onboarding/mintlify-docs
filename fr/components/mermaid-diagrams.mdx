...
[Mermaid](https://mermaid.js.org/) vous permet de créer des organigrammes, des diagrammes de séquence, des diagrammes de Gantt et d’autres types de diagrammes à partir de texte et de code.
...
```mermaid
  flowchart LR
    ...
    %% ^ Ces sous-graphes sont identiques, à la différence des liens qui y mènent :
