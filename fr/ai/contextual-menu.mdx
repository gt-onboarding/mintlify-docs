...
<Frame>
    ...
    alt="Le menu contextuel déployé affichant les éléments Copier la page, Afficher en Markdown, Ouvrir dans ChatGPT et Ouvrir dans Claude." 
  />
</Frame>
...
Ajoutez le champ `contextual` à votre fichier `docs.json` et indiquez les options à inclure.
...
<ResponseField name="description" type="string" required>
  La description de l’option. Affichée sous le titre lorsque le menu contextuel est déplié.
</ResponseField>

<IconsRequired />

<ResponseField name="href" type="string | object" required>
  La valeur href de l’option. Utilisez une chaîne pour les liens simples ou un objet pour les liens dynamiques avec des paramètres de requête.
