...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Découvrez la nouvelle génération de documentation. Nativement IA, élégante dès l’origine et pensée pour les développeurs.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Démarrage rapide" description="Déployez votre premier site de docs en quelques minutes grâce à notre guide étape par étape" href="/fr/quickstart" />

      <HeroCard filename="cli" title="Installation du CLI" description="Installez le CLI pour prévisualiser et développer vos docs en local" href="/fr/installation" />

      <HeroCard filename="editor" title="Éditeur web" description="Effectuez des mises à jour rapides et gérez votre contenu avec notre éditeur dans le navigateur" href="/fr/editor" />
