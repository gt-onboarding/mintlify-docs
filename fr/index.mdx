---
title: "Introduction"
description: "Découvrez la nouvelle génération de documentation. Native IA, superbe dès la première utilisation, conçue pour les développeurs."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Découvrez la nouvelle génération de documentation. Conçue avec l’IA, élégante dès le départ et pensée pour les développeurs.
    </div>
