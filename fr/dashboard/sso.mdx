...
<Tabs>
    <Tab title="SAML">
        <Steps>
            <Step title="Créer une application">
                Sous `Applications`, cliquez pour créer une nouvelle intégration d’application utilisant SAML 2.0.
            </Step>
    ...
    <Tab title="OIDC">
        <Steps>
            <Step title="Créer une application">
                Sous `Applications`, cliquez pour créer une nouvelle intégration d’application utilisant OIDC.
                Sélectionnez le type d’application `Web Application`.
            </Step>
            <Step title="Configurer l’intégration">
                Sélectionnez le type de flux Authorization Code et saisissez l’URI de redirection fournie par Mintlify.
            </Step>
            <Step title="Envoyez-nous les informations de votre IdP">
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurer SAML">
                Accédez à la page de configuration du Single Sign-On et sélectionnez **SAML**. Sous « Basic SAML Configuration », saisissez les informations suivantes :
            ...
            <Step title="Envoyer à Mintlify vos informations IdP">
