...
<Tip>
  Pour vérifier que votre schéma AsyncAPI est valide, vous pouvez le coller dans
...
Si vous souhaitez mieux contrôler l’ordre de vos canaux ou si vous souhaitez simplement référencer un canal unique, vous pouvez créer un fichier MDX avec le champ `asyncapi` dans le frontmatter.
