...
description: "Afficher des exemples de code spécifiques à un langage à côté de vos endpoints d’API pour montrer aux développeurs comment utiliser vos SDK"
---
...
Voici un exemple d’exemples de code pour une application de suivi des plantes, qui propose à la fois un outil CLI Bash et un SDK JavaScript.
