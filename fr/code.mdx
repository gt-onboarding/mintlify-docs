...
Activez le surlignage de la syntaxe en indiquant le langage de programmation après les backticks ouvrants d’un bloc de code.

Nous utilisons [Shiki](https://shiki.style/) pour le surlignage de la syntaxe et prenons en charge tous les langages disponibles. Consultez la liste complète des [langages](https://shiki.style/languages) dans la documentation de Shiki.
...
Affichez un diff visuel des lignes ajoutées ou supprimées dans vos blocs de code. Les lignes ajoutées sont mises en surbrillance en vert et les lignes supprimées en rouge.
