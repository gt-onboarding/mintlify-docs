...
description: "Personnalisez entièrement votre documentation avec du CSS et du JS"
icon: "code"
---
...
Tout fichier `.js` placé dans le répertoire de contenu de votre documentation sera inclus sur chaque page. Par exemple, vous pouvez ajouter le fichier `ga.js` suivant pour activer [Google Analytics](https://marketingplatform.google.com/about/analytics) sur l’ensemble de la documentation.
