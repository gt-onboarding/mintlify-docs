...
Ajoutez des images pour apporter un contexte visuel, des exemples ou une touche décorative à votre documentation.
...
Pour un contrôle plus précis de l’affichage des images, utilisez des balises HTML `<img>` :
...
<Note>
  Avec la syntaxe JSX, écrivez les attributs composés de deux mots en camelCase : `autoPlay`, `playsInline`, `allowFullScreen`.
</Note>
