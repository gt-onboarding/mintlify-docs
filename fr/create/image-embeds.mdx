...
<Tip>
  Ajoutez toujours un texte alternatif descriptif pour améliorer l’accessibilité et le référencement (SEO). Le texte alternatif doit décrire clairement ce que montre l’image.
</Tip>
...
Utilisez des styles JSX en ligne avec l’attribut `style` pour redimensionner des images :
...
<Tip>
  Incluez toujours un texte de repli à l’intérieur des éléments vidéo pour les navigateurs qui ne prennent pas en charge la lecture des vidéos.
</Tip>
...
Pour lire une vidéo automatiquement, utilisez :
