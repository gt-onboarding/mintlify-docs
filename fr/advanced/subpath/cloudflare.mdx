---
title: "Cloudflare"
description: "Hébergez la documentation à un sous-chemin personnalisé avec Cloudflare Workers"
---
...
Si vous utilisez Cloudflare comme proxy avec des déploiements Vercel, vous devez veiller à une configuration adéquate pour éviter les conflits avec la vérification de domaine de Vercel et l’émission des certificats SSL.
...
Consultez la section [Add a custom domain](https://developers.cloudflare.com/workers/configuration/routing/custom-domains/#add-a-custom-domain) dans la documentation Cloudflare pour en savoir plus. 
