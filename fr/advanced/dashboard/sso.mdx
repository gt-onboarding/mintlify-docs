...
<Tabs>
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Envoyez-nous les informations de votre IdP">
                Une fois l’application configurée, accédez à l’onglet General et relevez le client ID et le client secret.
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            <Step title="Créer une application">
                Dans `Web and mobile apps`, sélectionnez `Add custom SAML app` depuis le menu déroulant `Add app`.  
                <Frame>
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurer SAML">
                Accédez à la page de configuration du Single Sign-On et sélectionnez **SAML**. Sous "Basic SAML Configuration", saisissez ce qui suit :
            ...
            <Step title="Configurer les attributs et revendications">
