...
description: "Personnalisez la manière dont votre équipe se connecte à votre tableau de bord d’administration"
---
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Envoyez-nous les informations de votre IdP">
                Une fois l’application configurée, accédez à l’onglet Connexion et envoyez-nous l’URL des métadonnées.
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Configurer l'intégration">
                Sélectionnez le type de flux d’autorisation Authorization Code et saisissez l’URI de redirection fourni par Mintlify.
            </Step>
            <Step title="Envoyez-nous les informations de votre IdP">
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            <Step title="Créer une application">
                Dans `Web and mobile apps`, sélectionnez `Add custom SAML app` dans le menu déroulant `Add app`.  
                <Frame>
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configure SAML">
                Accédez à la page de configuration de l’authentification unique et sélectionnez **SAML**. Sous « Basic SAML Configuration », saisissez les informations suivantes :
                * Identifier (Entity ID) : l’Audience URI fourni par Mintlify.
                * Reply URL (Assertion Consumer Service URL) : l’ACS URL fournie par Mintlify.
