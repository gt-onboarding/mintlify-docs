...
Accédez à l’éditeur visuel depuis votre [tableau de bord](https://dashboard.mintlify.com/editor) pour gérer votre documentation directement dans votre navigateur.

* **Édition WYSIWYG** : Modifiez votre documentation avec un éditeur WYSIWYG (what you see is what you get) qui affiche le rendu tel qu’il apparaîtra une fois publié.
...
<Steps>
  ...
  <Step title="Publiez vos modifications">
    Si vous travaillez sur votre branche de déploiement, publiez vos modifications directement depuis l’éditeur visuel. Sur les autres branches, créez une pull request pour relecture avant la publication.
  </Step>
</Steps>
...
Utilisez l’interrupteur de mode dans la barre d’outils de l’éditeur pour passer d’un mode à l’autre.
...
Le mode visuel offre une expérience WYSIWYG, où les modifications effectuées dans l’éditeur reflètent fidèlement l’apparence de votre documentation publiée. Ce mode est idéal lorsque vous souhaitez prévisualiser vos changements en temps réel.
...
Le mode Markdown donne un accès direct au code `MDX` sous-jacent de votre documentation. Ce mode est idéal lorsque vous avez besoin d’un contrôle précis des propriétés des composants ou que vous préférez écrire avec la syntaxe Markdown.
...
Cliquez sur l’icône **Create a new file** dans la barre latérale de l’explorateur de fichiers.
...
<Frame>
  ...
  height: '400px',
    ...
    alt="Menu de l’extension de fichier dans l’éditeur visuel."
  />
  ...
  height: '400px',
    ...
    alt="Menu de l’extension de fichier dans l’éditeur visuel en mode sombre."
  />
</Frame>
...
Pour renommer une page, cliquez sur l’icône à trois points (kebab) du fichier à renommer. Sélectionnez **Renommer** dans le menu déroulant.
...
Pour supprimer une page, cliquez sur l’icône du menu à trois points du fichier à supprimer. Choisissez **Delete** dans le menu déroulant.
...
Modifiez votre fichier `docs.json` pour ajouter de nouvelles pages et retirer celles qui ont été supprimées de la navigation de votre site. Consultez [Navigation](/fr/organize/navigation) pour plus d’informations sur l’organisation des pages.

**Exemple : ajouter une page Thèmes au groupe Profile**

Dans cet exemple, vous avez créé une nouvelle page intitulée Thèmes et vous souhaitez l’ajouter au groupe Profile dans votre documentation. Ajoutez le chemin vers la nouvelle page dans le tableau `pages` du groupe `Profile` de votre fichier `docs.json` pour qu’elle apparaisse dans la navigation de votre site.
...
<Frame>
  <img src="/images/editor/component-menu-light.png" alt="Le menu des composants déroulé, mis en évidence dans l’éditeur visuel Mintlify" className="block dark:hidden" />

  <img src="/images/editor/component-menu-dark.png" alt="Le menu des composants déroulé, mis en évidence dans l’éditeur visuel Mintlify" className="hidden dark:block" />
</Frame>
...
Consultez [Mettre en forme le texte](/fr/create/text) et [Mettre en forme le code](/fr/create/code) pour plus d’informations sur l’écriture avec la syntaxe Markdown.
...
* **Branche de déploiement** : La publication met immédiatement à jour votre site en production.
* **Autres branches** : La publication crée une pull request afin que vous puissiez examiner les modifications avant de les déployer en production.

<Frame>
  <img src="/images/editor/publish-flow-light.png" alt="Le bouton Publish mis en évidence dans l’éditeur visuel Mintlify" className="block dark:hidden" />

  <img src="/images/editor/publish-flow-dark.png" alt="Le bouton Publish mis en évidence dans l’éditeur visuel Mintlify" className="hidden dark:block" />
</Frame>
...
Les pull requests vous permettent de proposer des modifications depuis votre branche afin que d&#39;autres puissent les examiner avant de les fusionner dans votre documentation en production. Cela permet de s&#39;assurer que vos modifications sont correctes et offre à votre équipe l&#39;occasion de collaborer sur le contenu.
...
<Steps>
  <Step title="Enregistrer votre travail">
    Sélectionnez **Save Changes** pour enregistrer toutes les modifications sur votre branche.
  </Step>

  <Step title="Créer la pull request">
    Sélectionnez **Publish Pull Request** depuis la barre d’outils de l’éditeur.
  </Step>
...
3. **Apporter des modifications supplémentaires** : Apportez des modifications supplémentaires dans l’éditeur visuel. Lorsque vous enregistrez, l’éditeur les pousse vers votre pull request.
...
Trouvez des solutions aux problèmes courants que vous pouvez rencontrer en utilisant l’éditeur visuel.
...
* Découvrez les bonnes pratiques de collaboration avec les [branches](/fr/guides/branches)