...
description: "Apprenez à mettre en forme le texte, créer des en-têtes et styliser le contenu"
icon: "heading"
---
...
<Info>
  La prise en charge de LaTeX nécessite une syntaxe mathématique correcte. Consultez la [documentation LaTeX](https://www.latex-project.org/help/documentation/) pour des consignes détaillées sur la syntaxe.
</Info>
