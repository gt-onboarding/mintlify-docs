...
Intégrez des widgets de support client dans votre documentation. Ajoutez le champ `integrations` à votre fichier `docs.json` avec l’identifiant (ID) de votre application.
