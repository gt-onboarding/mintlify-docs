---
title: "はじめに"
description: "次世代のドキュメントを体験しましょう。AIネイティブ、箱から出してすぐに美しく、開発者のために設計されています。"
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      次世代のドキュメンテーション。AIネイティブ、初期設定のまま美しく、開発者のために設計。いまや多言語対応です。
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="クイックスタート" description="ステップバイステップガイドで数分で最初のドキュメントサイトをデプロイ" href="/ja/quickstart" />

      <HeroCard filename="cli" title="CLIのインストール" description="ローカルでのプレビューと開発のためにCLIをインストール" href="/ja/installation" />

      <HeroCard filename="editor" title="Webエディタ" description="ブラウザベースのエディタで素早く更新し、コンテンツを管理" href="/ja/editor" />
