...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Palm" value="palm" description="エンタープライズ向けドキュメントのための高いカスタマイズ性を備えた洗練されたフィンテックテーマ。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="余計な装飾を排した、ドキュメントに集中できるミニマルな必需要素。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="等幅フォントで80年代のハッカー風味を感じさせるレトロなターミナルスタイル。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="カードベースの構成とミニマルデザインで、直感的にナビゲーションできるテーマ。" href="https://almond.mintlify.app" />

    <ThemeCard title="Aspen" value="aspen" description="複雑なナビゲーションやカスタムコンポーネントに対応して設計されたモダンなドキュメントテーマ。" href="https://aspen.mintlify.app" />
  </div>
</div>
