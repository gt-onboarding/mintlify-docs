---
title: "Introdução"
description: "Conheça a próxima geração de documentação. Nativa em IA, linda desde o primeiro uso e criada para desenvolvedores."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Conheça a próxima geração de documentação. Nativa em IA, elegante desde o início e feita para desenvolvedores.
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="editor" title="Editor web" description="Faça atualizações rápidas e gerencie o conteúdo com nosso editor baseado no navegador" href="/pt-BR/editor" />
