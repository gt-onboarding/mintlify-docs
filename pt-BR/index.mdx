---
title: "Introdução"
description: "Conheça a próxima geração de documentação. Nativa em IA, linda desde o primeiro momento e feita para desenvolvedores."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Conheça a próxima geração de documentação. Nativa de IA, bonita desde o primeiro uso e feita para desenvolvedores.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Guia de início rápido" description="Coloque seu primeiro site de docs no ar em minutos com nosso passo a passo" href="/pt-BR/quickstart" />
