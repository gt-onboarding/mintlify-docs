...
Use single sign-on no painel via SAML e OIDC. Se você usa Okta, Google Workspace ou Microsoft Entra, temos documentação específica para configurar o SSO com esses provedores. Se você usa outro provedor, [entre em contato conosco](mailto:support@mintlify.com).
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Envie as informações do seu IdP">
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Envie as informações do seu IdP">
                ...
                Forneça esses dados com segurança, juntamente com a URL da sua instância Okta (por exemplo, `<your-tenant-name>.okta.com`). Você pode enviá-los por um serviço como 1Password ou SendSafely.
            </Step>
        </Steps>
    </Tab>
</Tabs>
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Enviar suas informações de IdP para a Mintlify">
