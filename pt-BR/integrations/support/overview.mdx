---
title: "Integrações com suporte"
description: "Integre um widget de suporte"
---
...
<div id="enabling-support-integrations">
  ## Ativando integrações de suporte
</div>

Integre widgets de suporte ao cliente à sua documentação. Adicione o campo `integrations` ao arquivo `docs.json` com o respectivo ID do aplicativo.
