...
<Card title="Horizontal card" icon="text" horizontal>
  Este é um exemplo de um card horizontal.
</Card>
...
<Card title="Link card" icon="link" href="/pt-BR/components/columns" arrow="true" cta="Click here">
  Este é um exemplo de cartão com ícone e link. Ao clicar neste cartão, você será levado à página Columns.
</Card>
...
<ResponseField name="img" type="string">
  URL ou caminho local de uma imagem exibida na parte superior do card.
</ResponseField>
