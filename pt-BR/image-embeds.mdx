...
Todos os recursos estáticos no seu repositório de docs são disponibilizados automaticamente no caminho apropriado do seu domínio. Por exemplo, se você tiver `/images/my-logo.png` no seu repositório, a imagem estará disponível em `https://docs.yoursite.com/images/my-logo.png`.
...
A Mintlify oferece suporte a [tags HTML em Markdown](https://www.markdownguide.org/basic-syntax/#html), dando a você flexibilidade para criar conteúdo rico.
