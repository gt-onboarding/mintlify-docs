...
Este exemplo declara um componente `Counter` e, em seguida, o usa com `<Counter />`.
...
Este exemplo declara um componente `ColorGenerator` que usa vários hooks do React e, em seguida, o utiliza em um arquivo `MDX`.
