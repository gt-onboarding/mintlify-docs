...
Si utilizas Autenticación parcial para restringir el acceso a tu documentación, puedes obtener una vista previa como un grupo de autenticación específico usando la opción `--group [groupname]`.
...
Si bien `mint dev` es el comando más utilizado, existen otros comandos que puedes usar para gestionar tu documentación.

<div id="finding-broken-links">
  ### Detectar enlaces rotos
</div>

La CLI puede ayudarte a validar los enlaces de referencia incluidos en tu documentación. Para identificar enlaces rotos, utiliza el siguiente comando:
