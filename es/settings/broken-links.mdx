...
Cuando cambias la ruta de un archivo en la carpeta de docs, también cambia la URL de esa página. Esto puede ocurrir al reestructurar la documentación o al cambiar el título de la barra lateral.
...
La CLI identifica cualquier enlace relativo en tu documentación que no existe.
