...
Usa CSS para estilizar elementos HTML o añade CSS y JavaScript personalizados para adaptar por completo la apariencia y la experiencia de tu documentación.

<div id="styling-with-tailwind-css">
  ## Estilos con Tailwind CSS
</div>

Use Tailwind CSS v3 para estilizar elementos HTML. Puede controlar el diseño, el espaciado, los colores y otras propiedades visuales. Algunas clases comunes son:
...
Los valores arbitrarios de Tailwind CSS no son compatibles. Para valores personalizados, use la prop `style`.
...
Agrega archivos CSS a tu repositorio y los nombres de clase que definan se aplicarán y estarán disponibles en todos tus archivos de `MDX`.

<div id="adding-stylecss">
  ### Incorporar `style.css`
</div>
...
<Tip>
  Usa la herramienta Inspeccionar (Inspect element) para encontrar referencias a los elementos que deseas personalizar.
</Tip>
...
<Warning>
  Las referencias y el estilo de los elementos comunes pueden cambiar a medida que la plataforma evoluciona. Use estilos personalizados con precaución.
</Warning>
...
JavaScript personalizado te permite agregar código ejecutable propio de forma global. Es equivalente a insertar una etiqueta `<script>` con código JavaScript en cada página.
