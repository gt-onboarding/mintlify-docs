...
Cualquier archivo `.js` dentro del directorio de contenido de tu documentación se incluirá en cada página. Por ejemplo, puedes agregar el siguiente archivo `ga.js` para habilitar [Google Analytics](https://marketingplatform.google.com/about/analytics) en toda la documentación.
