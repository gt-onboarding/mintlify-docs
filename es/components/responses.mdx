...
El componente `<ResponseField>` está diseñado para definir los valores devueltos por una API. Muchos documentos también usan `<ResponseField>` en las páginas cuando necesitas enumerar los tipos de algo.
