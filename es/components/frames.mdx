...
Utiliza marcos para mostrar imágenes, diagramas u otro contenido visual con un estilo uniforme y leyendas opcionales. Los marcos centran el contenido y ofrecen separación visual del texto circundante.
...
<ResponseField name="caption" type="string">
  Texto de pie opcional para mostrar centrado debajo de tu componente.
</ResponseField>
