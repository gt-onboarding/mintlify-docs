...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personalice la apariencia de su documentación<br /><br />Configure [theme](es/settings#param-theme) en docs.json usando uno de los siguientes temas.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Palm" value="palm" description="Tema fintech sofisticado con una amplia personalización para documentación empresarial." href="https://palm.mintlify.app" />
