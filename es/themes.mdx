...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">Personaliza la apariencia de tu documentación<br /><br />Configura [theme](es/settings#param-theme) en docs.json con uno de los siguientes temas.</label>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    ...
    <ThemeCard title="Linden" value="linden" description="Estética de terminal retro con tipografías monoespaciadas y ese aire hacker de los 80." href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="Organización por tarjetas con diseño minimalista para una navegación intuitiva." href="https://almond.mintlify.app" />
