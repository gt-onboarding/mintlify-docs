...
description: "Personaliza cómo tu equipo puede acceder al panel de administración"
---
...
Usa el inicio de sesión único en tu panel mediante SAML y OIDC. Si utilizas Okta, Google Workspace o Microsoft Entra, contamos con documentación específica por proveedor para configurar SSO. Si utilizas otro proveedor, [contáctanos](mailto:support@mintlify.com).
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Send us your IdP information">
                Una vez configurada la aplicación, ve a la pestaña Sign-On y envíanos la metadata URL.
    ...
    <Tab title="OIDC">
        <Steps>
            ...
            <Step title="Configure integration">
                Selecciona el tipo de grant Authorization Code e ingresa el Redirect URI proporcionado por Mintlify.
            </Step>
            <Step title="Send us your IdP information">
                Una vez configurada la aplicación, ve a la pestaña General y localiza el client ID y el client secret.
                Por favor, proporciónanos estos de forma segura, junto con la URL de tu instancia de Okta (por ejemplo, `<your-tenant-name>.okta.com`). Puedes enviarlos mediante un servicio como 1Password o SendSafely.
            </Step>
        </Steps>
    </Tab>
</Tabs>
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="Configurar SAML">
                Ve a la página de configuración de Single Sign-On y selecciona **SAML**. En "Basic SAML Configuration", introduce lo siguiente:
            ...
            <Step title="Enviar a Mintlify tu información de IdP">
                ...
                Habilitaremos la conexión por nuestro lado usando esta información.
            </Step>
