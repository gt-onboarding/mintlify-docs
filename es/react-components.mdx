...
Los [componentes de React](https://react.dev) son una manera potente de crear elementos interactivos y reutilizables en tu documentación.
...
El contador se representa como un componente de React interactivo.
...
El generador de colores se muestra como un componente de React interactivo.
