...
Para agregar una tabla, usa tres o más guiones (`---`) para crear el encabezado de cada columna y usa barras verticales (`|`) para separar cada columna. Para compatibilidad, también debes agregar una barra vertical al principio y al final de cada fila.
