...
description: "Añade imágenes, videos y iframes"
---
...
<div id="html-image-embeds">
  ### Incrustación de imágenes en HTML
</div>

Para tener mayor control sobre la visualización de imágenes, utiliza etiquetas `<img>` en HTML:
...
Para mostrar imágenes diferentes en temas claro y oscuro, usa clases de Tailwind CSS:
...
<Card title="Referencia del componente Frame" icon="frame" horizontal href="/es/components/frames">
  Aprende a utilizar el componente Frame para mostrar imágenes.
</Card>