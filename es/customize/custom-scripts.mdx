...
description: "Personaliza por completo tu documentación con CSS y JS"
---

Utiliza CSS para estilizar elementos HTML o agrega CSS y JavaScript personalizados para ajustar por completo el aspecto y el comportamiento de tu documentación.
...
Agrega archivos CSS a tu repositorio y los nombres de clase definidos se aplicarán y estarán disponibles en todos tus archivos de `MDX`.
...
<Tip>
  Usa la herramienta Inspeccionar (Inspect Element) para encontrar referencias a los elementos que quieres personalizar.
</Tip>
...
El JavaScript personalizado te permite agregar código ejecutable de forma global. Es equivalente a insertar una etiqueta `<script>` con código JS en cada página.
