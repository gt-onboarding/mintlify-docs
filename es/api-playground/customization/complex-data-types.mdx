...
description: "Describe APIs con esquemas flexibles, propiedades opcionales y múltiples formatos de datos utilizando las palabras clave `oneOf`, `anyOf` y `allOf`"
---
...
<ParamField body="org_with_users" type="object">
  <Expandable>
    ...
    <ParamField body="users" type="object[]">
      Una lista que contiene a todos los usuarios de la organización
    </ParamField>
  </Expandable>
</ParamField>
