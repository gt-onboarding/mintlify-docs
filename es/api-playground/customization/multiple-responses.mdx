...
Si su API devuelve distintas respuestas según los parámetros de entrada, el contexto del usuario u otras condiciones de la solicitud, puede documentar múltiples ejemplos de respuesta con la propiedad `examples`.
