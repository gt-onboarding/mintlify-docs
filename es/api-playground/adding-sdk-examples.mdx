...
Aquí tienes un ejemplo de fragmentos de código para una app de seguimiento de plantas, que incluye tanto una herramienta CLI en Bash como un SDK de JavaScript.
