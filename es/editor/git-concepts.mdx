...
<AccordionGroup>
  ...
  <Accordion title="Branch">
    Una rama apunta a un commit específico en tu repositorio. Tu documentación en producción se genera a partir de una rama de despliegue. Puedes tener cualquier cantidad de otras ramas con cambios que aún no se han publicado en tu documentación en producción. Si quieres incorporar los cambios de una rama a tu documentación en producción, puedes fusionarla en tu rama de despliegue mediante una pull request.
  ...
  <Accordion title="Deployment branch">
    La rama principal de tu proyecto a partir de la cual se genera el contenido de tu documentación en producción. Los cambios en esta rama se publican automáticamente en tu sitio de documentación. A menudo se llama `main`, pero puedes configurar cualquier rama como tu rama de despliegue.
  </Accordion>
