...
* **Cambios de editor**: Cuando un editor publica a través del Editor web o fusiona una pull request en tu repositorio de documentación, los cambios se despliegan automáticamente en tu sitio en producción.
* **Cambios de no editor**: Cuando una persona que no es editora fusiona una pull request en tu repositorio, debes activar manualmente un despliegue desde tu panel para que esos cambios aparezcan en tu sitio en producción.
