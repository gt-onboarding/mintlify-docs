...
El menú contextual ofrece acceso rápido a contenido optimizado para IA e integraciones directas con herramientas de IA populares. Al seleccionar el menú contextual en cualquier página, los usuarios pueden copiar contenido para usarlo como contexto en herramientas de IA o abrir conversaciones en ChatGPT, Claude, Perplexity o en una herramienta personalizada de su elección, con su documentación ya cargada como contexto.
