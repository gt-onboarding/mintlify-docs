...
<Tabs>
  <Tab title="Password">
    ...
    * Tus políticas de seguridad permiten compartir contraseñas entre usuarios.
    ...
    Tu documentación está alojada en `docs.foo.com` y necesitas un control de acceso básico sin hacer seguimiento de usuarios individuales. Quieres impedir el acceso público manteniendo una configuración sencilla.
  ...
  <Tab title="OAuth 2.0">
    ...
    * Capacidad para crear un endpoint de API accesible mediante tokens de acceso de OAuth (opcional, para habilitar funciones de personalización).
    ...
    <Steps>
      <Step title="Configura tus ajustes de OAuth.">
        ...
        * **Client Secret**: El secreto de cliente de OAuth 2.0.
        ...
        * **Logout URL**: La URL nativa de cierre de sesión de tu proveedor de OAuth. Si tu proveedor tiene un parámetro `returnTo` o similar, haz que apunte de vuelta a la URL de tu documentación.

        4. Selecciona **Save changes**.
      </Step>

      <Step title="Configura tu servidor de OAuth.">
        1. Copia la **Redirect URL** desde tus [authentication settings](https://dashboard.mintlify.com/settings/deployment/authentication).
      ...
      <Step title="Crea tu endpoint de información de usuario (opcional).">
        ...
        * Devuelva datos de usuario en el formato `User`. Consulta [User data format](/es/authentication-personalization/personalization-setup#user-data-format) para más información.
        ...
        Agrega la URL de este endpoint en el campo **Info API URL** en tus [authentication settings](https://dashboard.mintlify.com/settings/deployment/authentication).
      </Step>
    </Steps>
    ...
    **Configura los detalles de tu servidor de OAuth** en tu panel:
    ...
    **Crea un endpoint de información de usuario** en `api.foo.com/docs/user-info`, que requiera un token de acceso de OAuth con el alcance `provider.users.docs`, y que devuelva:
  ...
  <Tab title="JWT">
    ...
    * Un servicio backend que pueda crear URLs de redirección.
