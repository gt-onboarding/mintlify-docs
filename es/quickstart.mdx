...
Para más detalles sobre el uso del editor web, incluidas las ramas y los pull requests para colaborar y previsualizar cambios, consulta nuestra [documentación del editor web](/es/editor/getting-started).
...
<Card title="Personaliza el tema" icon="paintbrush" href="es/themes" horizontal>
