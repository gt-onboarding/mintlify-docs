...
![GIF que muestra cómo acceder al soporte desde el panel al seleccionar el botón Support, luego elegir una opción y escribir una pregunta en el modal de soporte que aparece.](https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/support-flow.gif)
