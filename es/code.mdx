...
Usa [bloques de código con cercas](https://www.markdownguide.org/extended-syntax/#fenced-code-blocks) encerrando el código entre tres acentos graves. Los bloques de código se pueden copiar y, si tienes el Asistente habilitado, los usuarios pueden pedirle a la IA que explique el código.
...
Activa el ajuste de texto para líneas largas usando `wrap`. Esto evita el desplazamiento horizontal y hace que las líneas largas sean más fáciles de leer.
