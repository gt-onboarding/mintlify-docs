---
title: "Einführung"
description: "Lernen Sie die nächste Generation der Dokumentation kennen. KI-native, von Haus aus schön und für Entwickler entwickelt."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Die nächste Generation der Dokumentation: KI-native, von Haus aus schön und für Entwickler gemacht.
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="cli" title="CLI-Installation" description="Installieren Sie die CLI, um Ihre Docs lokal zu entwickeln und in der Vorschau zu testen" href="/de/installation" />
