...
Um mit dem Erstellen von Seiten für Ihre WebSockets zu beginnen, stellen Sie sicher, dass Sie ein gültiges AsyncAPI-Schemadokument im JSON- oder YAML-Format haben, das der [AsyncAPI-Spezifikation](https://www.asyncapi.com/docs/reference/specification/v3.0.0) entspricht. Ihr Schema muss der AsyncAPI-Spezifikation ab Version 3.0 folgen.

<Tip>
  Um die Gültigkeit Ihres AsyncAPI-Schemas zu überprüfen, können Sie es in
  das [AsyncAPI Studio](https://studio.asyncapi.com/) einfügen.
</Tip>
