...
Wenn Ihre Benutzer mit Ihrer API über ein SDK statt direkt per Netzwerkanfrage interagieren, können Sie die Erweiterung `x-codeSamples` verwenden, um Codebeispiele zu Ihrem OpenAPI-Dokument hinzuzufügen und sie auf Ihren OpenAPI-Seiten anzuzeigen.
