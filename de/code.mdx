...
Fügen Sie Ihrem Codeblock über die Eigenschaft `icon` ein Icon hinzu. Alle verfügbaren Optionen finden Sie unter [Icons](/de/components/icons).
...
Zeige einen visuellen Diff für hinzugefügte oder entfernte Zeilen in deinen Codeblöcken. Hinzugefügte Zeilen werden grün, entfernte Zeilen rot hervorgehoben.
