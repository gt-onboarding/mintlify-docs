...
Alle statischen Assets in Ihrem Docs-Repository werden automatisch unter dem entsprechenden Pfad auf Ihrer Domain ausgeliefert. Wenn Sie beispielsweise `/images/my-logo.png` in Ihrem Repo haben, ist das Bild unter `https://docs.yoursite.com/images/my-logo.png` verfügbar.
...
Verwende die [Markdown-Syntax](https://www.markdownguide.org/basic-syntax/#images), um Bilder zu deiner Dokumentation hinzuzufügen:
...
Bilddateien müssen kleiner als 20 MB sein. Größere Dateien solltest du über einen CDN-Dienst wie [Amazon S3](https://aws.amazon.com/s3) oder [Cloudinary](https://cloudinary.com) hosten.
...
Mintlify unterstützt [HTML-Tags in Markdown](https://www.markdownguide.org/basic-syntax/#html) und gibt Ihnen die Flexibilität, reichhaltige Inhalte zu erstellen.
