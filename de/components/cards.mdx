---
title: "Karten"
description: "Hebe Hauptpunkte oder Links mit anpassbaren Layouts und Symbolen hervor"
...
<Card title="Card title" icon="text" href="/de/components/columns">
  So verwendest du eine Karte mit einem Symbol und einem Link. Ein Klick auf diese Karte
...
Karten unterstützen mehrere Layout- und Stylingoptionen, um unterschiedlichen Inhaltsanforderungen gerecht zu werden.
...
<ResponseField name="color" type="string">
  Symbolfarbe als Hexcode (z. B. `#FF6B6B`).
</ResponseField>
