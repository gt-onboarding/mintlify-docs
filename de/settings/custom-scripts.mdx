...
description: "Passen Sie Ihre Dokumentation mit benutzerdefiniertem CSS und JS umfassend an"
icon: "code"
---

Verwenden Sie CSS, um HTML-Elemente zu stylen, oder fügen Sie benutzerdefiniertes CSS und JavaScript hinzu, um das Erscheinungsbild und Verhalten Ihrer Dokumentation umfassend anzupassen.
...
Beliebige Werte in Tailwind CSS werden nicht unterstützt. Für benutzerdefinierte Werte verwenden Sie stattdessen die `style`-Prop.
...
Sie können beispielsweise die folgende Datei `style.css` hinzufügen, um die Gestaltung der Navbar und der Fußzeile anzupassen.
...
Mintlify stellt eine Reihe gängiger Identifikatoren und Selektoren bereit, mit denen Sie wichtige Elemente der Benutzeroberfläche markieren können.

<Tip>
  Nutzen Sie „Element untersuchen“, um die Elemente zu finden, die Sie anpassen möchten.
</Tip>
...
<Warning>
  Referenzen und das Styling gängiger Elemente können sich mit der Weiterentwicklung der Plattform ändern. Bitte verwenden Sie benutzerdefiniertes Styling mit Vorsicht.
</Warning>
...
Benutzerdefiniertes JS ermöglicht es, global eigenen ausführbaren Code hinzuzufügen. Es entspricht dem Einfügen eines `<script>`-Tags mit JS-Code auf jeder Seite.

<div id="adding-custom-javascript">
  ### Benutzerdefiniertes JavaScript hinzufügen
</div>

Alle `.js`-Dateien im Content-Verzeichnis Ihrer Dokumentation werden auf jeder Dokumentationsseite eingebunden. Sie können beispielsweise die folgende Datei `ga.js` hinzufügen, um [Google Analytics](https://marketingplatform.google.com/about/analytics) für die gesamte Dokumentation zu aktivieren.
