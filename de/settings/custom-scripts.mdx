...
description: "Passen Sie Ihre Dokumentation vollständig mit benutzerdefiniertem CSS und JS an"
icon: "code"
---
...
Jede `.js`-Datei im Content-Verzeichnis deiner Dokumentation wird auf jeder Dokumentationsseite geladen. Du kannst zum Beispiel die folgende Datei `ga.js` hinzufügen, um [Google Analytics](https://marketingplatform.google.com/about/analytics) für die gesamte Dokumentation zu aktivieren.
