...
description: "In ein Support-Widget integrieren"
---
...
Binden Sie Kundensupport-Widgets in Ihre Dokumentation ein. Fügen Sie in Ihrer `docs.json`-Datei das Feld `integrations` mit der jeweiligen App-ID hinzu.
