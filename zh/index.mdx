---
title: "简介"
description: "迎接新一代文档：AI 原生、开箱即美观，为开发者而生。"
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      迎接新一代文档：AI 原生、开箱即美、专为开发者打造。现已支持多语言！
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="快速上手" description="按照我们的分步指南，用几分钟部署你的首个文档站点" href="/zh/quickstart" />

      <HeroCard filename="cli" title="CLI 安装" description="安装 Mint 命令行工具（mint），在本地预览并开发你的文档" href="/zh/installation" />

      <HeroCard filename="editor" title="Web 编辑器" description="使用基于浏览器的编辑器快速更新并管理内容" href="/zh/editor" />

      <HeroCard filename="components" title="组件" description="使用我们即用型组件构建丰富且交互式的文档" href="/zh/text" />
    </div>
  </div>
</div>
