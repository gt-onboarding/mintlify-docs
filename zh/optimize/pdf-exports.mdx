...
你可以将文档导出为单个 PDF 文件，方便离线查看。PDF 将包含文档中的所有内容，包括图片和链接，并提供可导航的目录。
...
1. 在仪表盘的 Project Settings 部分，前往 [General](https://dashboard.mintlify.com/settings/deployment/general) 页面。
2. 点击 **Export all content** 按钮。
3. 根据需要自定义导出选项：
    - **Page format**：选择 PDF 的纸张尺寸。
