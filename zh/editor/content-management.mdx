...
<Steps>
  ...
  <Step title="创建并打开">
    按 <kbd>Enter</kbd> 创建文件。文件会自动在编辑器中打开，等待你添加内容。
  </Step>
</Steps>
...
```json title="将 themes 页面添加到 Profile 组" highlight="18"
{
    "navigation": {
        "groups": [
            {
...
在可视化模式下，按 <kbd>/</kbd> 打开组件菜单。添加内容块、提示、代码块以及其他组件，来自定义文档。

<Frame>
  <img 
    src="/images/editor/component-menu-light.png" 
    alt="Mintlify 网页编辑器中展开的组件菜单（高亮显示）" 
