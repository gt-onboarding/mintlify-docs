...
通过 SAML 和 OIDC 使用单点登录访问仪表盘。若您使用 Okta、Google Workspace 或 Microsoft Entra，我们提供了针对各个身份提供商的 SSO 配置文档。若您使用其他提供商，请[联系我们](mailto:support@mintlify.com)。
    ...
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="将您的 IdP 信息发送给我们">
                应用设置完成后，前往 Sign-On 选项卡，并将 metadata URL 发送给我们。
                我们将基于这些信息在我们的端启用连接。
            </Step>
        </Steps>
    </Tab>
        ...
        <Steps>
            ...
            <Step title="配置集成">
                ...
                * Name ID：`Basic Information > Primary email`
                ...
                在下一页输入以下属性声明（attribute statements）：
...
<Tabs>
    <Tab title="SAML">
        <Steps>
            ...
            <Step title="配置 SAML">
                前往 Single Sign-On 设置页面并选择 **SAML**。在 “Basic SAML Configuration” 中输入以下内容：
            ...
            <Step title="将你的 IdP 信息发送给 Mintlify">
                完成应用设置后，前往 “SAML Certificates” 部分，并将 App Federation Metadata URL 发送给我们。
                我们会据此在我们端启用连接。
            </Step>
            <Step title="分配用户">
                在你的 Entra 应用中进入 “Users and groups”，添加应当能够访问你仪表板的用户。
            </Step>
        </Steps>
    </Tab>
</Tabs>