...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 中配置 [theme](zh/settings#param-theme)，并从以下主题中选择。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，采用久经考验的布局与熟悉的导航。" href="https://mint.mintlify.app" />
    ...
    <ThemeCard title="Willow" value="willow" description="回归核心要素，带来专注无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端氛围与等宽字体，呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式组织与极简设计结合，实现直观的导航。" href="https://almond.mintlify.app" />
