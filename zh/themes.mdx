...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，历经考验的布局与熟悉的导航。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代、简洁的美学风格，完美适配 AI 与 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="高级金融科技主题，支持企业文档的深度自定义。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="剥离至核心要素，带来无干扰的文档体验。" href="https://willow.mintlify.app" />
