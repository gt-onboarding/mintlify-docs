...
上下文菜单可快速访问经 AI 优化的内容，并直接集成主流 AI 工具。用户在任意页面打开上下文菜单时，可将内容复制为 AI 工具的上下文，或在 ChatGPT、Claude、Perplexity，或你选择的自定义工具中发起对话，且系统会预先将你的文档加载为上下文。
...
| **在 ChatGPT 中打开** | `chatgpt` | 基于当前页面上下文创建 ChatGPT 会话 |
| **在 Claude 中打开** | `claude` | 基于当前页面上下文创建 Claude 会话 |
| **在 Perplexity 中打开** | `perplexity` | 基于当前页面上下文创建 Perplexity 会话 |
