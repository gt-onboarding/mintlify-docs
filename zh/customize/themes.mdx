...
<div className="pt-10 pb-24 px-4 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <label className="text-lg prose prose-gray dark:prose-invert">自定义文档的外观<br /><br />在 docs.json 中配置 [theme](/zh/organize/settings#param-theme)，从以下主题中进行选择。</label>

  <br />

  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，具备久经考验的布局与熟悉的导航。" href="https://mint.mintlify.app" />

    <ThemeCard title="Maple" value="maple" description="现代、简洁的美学风格，完美适配 AI 与 SaaS 产品。" href="https://maple.mintlify.app" />

    <ThemeCard title="Palm" value="palm" description="高级金融科技主题，为企业级文档提供深度自定义能力。" href="https://palm.mintlify.app" />

    <ThemeCard title="Willow" value="willow" description="精简至要，带来无干扰的文档体验。" href="https://willow.mintlify.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端风格，等宽字体呈现 80 年代黑客美学。" href="https://linden.mintlify.app" />
